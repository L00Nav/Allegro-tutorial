...
//https://github.com/liballeg/allegro_wiki/wiki/Allegro-Vivace-%E2%80%93-Graphics
...
int main_two()
{
    ...
    while (1)
    {
        ...
        if (redraw && al_is_event_queue_empty(queue))
        {
            ...
            al_draw_filled_circle(400, 400, 30, al_map_rgb_f(1, 0, 1));
            al_draw_line(440, 110, 460, 210, al_map_rgb_f(1, 0, 0), 1);
            al_draw_line(500, 220, 570, 200, al_map_rgb_f(1, 1, 0), 1);

            ALLEGRO_VERTEX v[] = {
                {210, 320, 0, 0, 0, al_map_rgb_f(1, 0, 0) },
                {330, 320, 0, 0, 0, al_map_rgb_f(0, 1, 0) },
                {210, 420, 0, 0, 0, al_map_rgb_f(0, 0, 1) },
                {330, 420, 0, 0, 0, al_map_rgb_f(1, 1, 0) },
            };
